...
import '../style.css/common/Login.css';
  ...
  return (
    ...
    <div className='wrapper'>
      ...
      <div className='login-form-wrap'>
        ...
        {/* 로그인 배경 및 컨텐츠 요소의 박스 영역 */}
        <div className='login-form'>

          {/* 로그인 heading 구간 : 로고와 안내문구 */}
          <div className='login-heading'>
            <a className='login-heading__logo'>
            ...
            <h5 className='login-heading__info'>코디허브 서비스 이용을 위해 로그인을 해주세요.</h5>
          </div>

          {/* 로그인 content 구간 : 이름, 이메일 입력구간 */}
          <form className='login-content' onSubmit={checkSum}>
            <div className='login-content__name'>
              <label>이름</label>
              <input className='login-name-input' placeholder='이름을 입력하세요' onChange={(e) => setChange(e, "name")}></input>
            </div>

            <div className='login-content__email'>
              <label>이메일</label>
              <input className='login-email-input' placeholder='이메일을 입력하세요' onChange={(e) => setChange(e, "email")}></input>
            </div>
